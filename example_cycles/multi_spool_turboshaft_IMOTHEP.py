...
class MultiSpoolTurboshaft(pyc.Cycle):
    ...
    def setup(self):
        ...
        self.add_subsystem('hpt', pyc.Turbine(map_data=pyc.HPTMap, bleed_names=['cool1']),
                           promotes_inputs=[('Nmech','HP_Nmech')])
        ...
        #
        #     balance.add_balance('pt_PR', val=1.5, lower=1.001, upper=8, eq_units='kW',  rhs_name='pwr_target')
